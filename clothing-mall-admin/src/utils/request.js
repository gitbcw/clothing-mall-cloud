...
const ROUTE_MAP = {
  ...
  'stat/tracker/funnel': ['admin-stat', 'statTrackerFunnel'],
  'stat/tracker/banner-clicks': ['admin-stat', 'statTrackerBannerClicks'],
  'stat/tracker/config/list': ['admin-stat', 'trackerConfigList'],
  'stat/tracker/config/update': ['admin-stat', 'trackerConfigUpdate'],
  'stat/tracker/config/init': ['admin-stat', 'trackerConfigInit'],
  ...
  'stat/revenue/holiday': ['admin-stat', 'statRevenueHoliday'],
  'stat/revenue/special-price': ['admin-stat', 'statRevenueSpecialPrice'],

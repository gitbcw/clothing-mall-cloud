...
--
-- Host: localhost    Database: clothing_mall
-- ------------------------------------------------------
...
CREATE TABLE `clothing_color` (
  ...
  `name` varchar(50) NOT NULL COMMENT 'é¢œè‰²åç§°',
  `color_code` varchar(20) DEFAULT NULL COMMENT 'é¢œè‰²ä»£ç ï¼ˆHEXï¼‰',
  `sort_order` int(11) DEFAULT '0' COMMENT 'æŽ’åº',
  `enabled` tinyint(1) DEFAULT '1' COMMENT 'æ˜¯å¦å¯ç”¨',
  `add_time` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb4 COMMENT='é¢œè‰²é…ç½®è¡¨';
...
LOCK TABLES `clothing_color` WRITE;
/*!40000 ALTER TABLE `clothing_color` DISABLE KEYS */;
INSERT INTO `clothing_color` VALUES (27,'黑色','#000000',1,1,'2026-02-27 04:11:46'),(28,'白色','#FFFFFF',2,1,'2026-02-27 04:11:46'),(29,'灰色','#808080',3,1,'2026-02-27 04:11:46'),(30,'深灰','#505050',4,1,'2026-02-27 04:11:46'),(31,'米色','#F5F5DC',5,1,'2026-02-27 04:11:46'),(32,'卡其色','#C3B091',6,1,'2026-02-27 04:11:46'),(33,'藏青色','#000080',7,1,'2026-02-27 04:11:46'),(34,'深蓝色','#00008B',8,1,'2026-02-27 04:11:46'),(35,'天蓝色','#87CEEB',9,1,'2026-02-27 04:11:46'),(36,'红色','#FF0000',10,1,'2026-02-27 04:11:46'),(37,'酒红色','#722F37',11,1,'2026-02-27 04:11:46'),(38,'粉色','#FFC0CB',12,1,'2026-02-27 04:11:46');
/*!40000 ALTER TABLE `clothing_color` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `clothing_goods_sku` (
  ...
  `color` varchar(50) NOT NULL COMMENT 'é¢œè‰²',
  `color_image` varchar(255) DEFAULT NULL COMMENT 'é¢œè‰²å›¾ç‰‡',
  `size` varchar(20) NOT NULL COMMENT 'å°ºç ï¼šS/M/L/XL/XXL',
  `price` decimal(10,2) NOT NULL COMMENT 'SKUä»·æ ¼',
  `stock` int(11) DEFAULT '0' COMMENT 'åº“å­˜',
  `image_url` varchar(255) DEFAULT NULL COMMENT 'SKUå›¾ç‰‡',
  `bar_code` varchar(50) DEFAULT NULL COMMENT 'æ¡å½¢ç ',
  `is_default` tinyint(1) DEFAULT '0' COMMENT 'æ˜¯å¦é»˜è®¤SKU',
  `deleted` tinyint(1) DEFAULT '0' COMMENT 'é€»è¾‘åˆ é™¤',
  `add_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT 'åˆ›å»ºæ—¶é—´',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'æ›´æ–°æ—¶é—´',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_goods_color_size` (`goods_id`,`color`,`size`),
  KEY `idx_goods_id` (`goods_id`),
  KEY `idx_bar_code` (`bar_code`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COMMENT='å•†å“SKUè¡¨';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `clothing_goods_sku` VALUES (1,1181004,'T001-W-M','白色',NULL,'M',99.00,50,NULL,NULL,1,0,'2026-02-27 05:53:16','2026-02-27 05:53:16'),(2,1181004,'T001-W-L','白色',NULL,'L',99.00,30,NULL,NULL,0,0,'2026-02-27 05:53:16','2026-02-27 05:53:16'),(3,1181004,'T001-B-M','黑色',NULL,'M',99.00,40,NULL,NULL,0,0,'2026-02-27 05:53:16','2026-02-27 05:53:16'),(4,1181004,'T001-B-L','黑色',NULL,'L',99.00,25,NULL,NULL,0,0,'2026-02-27 05:53:16','2026-02-27 05:53:16'),(5,1181005,'J001-B-28','深蓝色',NULL,'28',199.00,20,NULL,NULL,1,0,'2026-02-27 05:53:16','2026-02-27 05:53:16'),(6,1181005,'J001-B-30','深蓝色',NULL,'30',199.00,30,NULL,NULL,0,0,'2026-02-27 05:53:16','2026-02-27 05:53:16'),(7,1181005,'J001-B-32','深蓝色',NULL,'32',199.00,25,NULL,NULL,0,0,'2026-02-27 05:53:16','2026-02-27 05:53:16'),(8,1181005,'J001-BK-30','黑色',NULL,'30',199.00,15,NULL,NULL,0,0,'2026-02-27 05:53:16','2026-02-27 05:53:16'),(9,1181006,'D001-B-M','黑色',NULL,'M',499.00,15,NULL,NULL,1,0,'2026-02-27 05:53:16','2026-02-27 05:53:16'),(10,1181006,'D001-B-L','黑色',NULL,'L',499.00,20,NULL,NULL,0,0,'2026-02-27 05:53:16','2026-02-27 05:53:16'),(11,1181006,'D001-N-M','藏青色',NULL,'M',499.00,10,NULL,NULL,0,0,'2026-02-27 05:53:16','2026-02-27 05:53:16'),(12,1181007,'S001-W-39','白色',NULL,'39',159.00,25,NULL,NULL,1,0,'2026-02-27 05:53:16','2026-02-27 05:53:16'),(13,1181007,'S001-W-41','白色',NULL,'41',159.00,20,NULL,NULL,0,0,'2026-02-27 05:53:16','2026-02-27 05:53:16'),(14,1181007,'S001-L-39','浅蓝色',NULL,'39',159.00,18,NULL,NULL,0,0,'2026-02-27 05:53:16','2026-02-27 05:53:16'),(15,1181008,'C001-K-M','卡其色',NULL,'M',399.00,12,NULL,NULL,1,0,'2026-02-27 05:53:16','2026-02-27 05:53:16'),(16,1181008,'C001-K-L','卡其色',NULL,'L',399.00,15,NULL,NULL,0,0,'2026-02-27 05:53:16','2026-02-27 05:53:16'),(17,1181008,'C001-B-M','黑色',NULL,'M',399.00,10,NULL,NULL,0,0,'2026-02-27 05:53:16','2026-02-27 05:53:16');
/*!40000 ALTER TABLE `clothing_goods_sku` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `clothing_guide`
--

DROP TABLE IF EXISTS `clothing_guide`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `clothing_guide` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL COMMENT 'å¯¼è´­å§“å',
  `phone` varchar(20) DEFAULT NULL COMMENT 'æ‰‹æœºå·',
  `avatar` varchar(255) DEFAULT NULL COMMENT 'å¤´åƒ',
  `store_id` int(11) DEFAULT NULL COMMENT 'é—¨åº—ID',
  `qrcode_url` varchar(255) DEFAULT NULL COMMENT 'ä¸“å±žäºŒç»´ç ',
  `commission_rate` decimal(3,2) DEFAULT '0.01' COMMENT 'ææˆæ¯”ä¾‹',
  `status` tinyint(1) DEFAULT '1' COMMENT 'çŠ¶æ€ï¼š0ç¦»èŒ 1åœ¨èŒ',
  `add_time` datetime DEFAULT CURRENT_TIMESTAMP,
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='å¯¼è´­è¡¨';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `clothing_guide`
--

LOCK TABLES `clothing_guide` WRITE;
/*!40000 ALTER TABLE `clothing_guide` DISABLE KEYS */;
INSERT INTO `clothing_guide` VALUES (1,'张小美','13800138001',NULL,1,NULL,0.01,1,'2026-02-27 05:51:03','2026-02-27 05:51:03',0),(2,'李小帅','13800138002',NULL,1,NULL,0.01,1,'2026-02-27 05:51:03','2026-02-27 05:51:03',0),(3,'张小美','13800138001',NULL,1,NULL,0.01,1,'2026-02-27 05:51:49','2026-02-27 05:51:49',0),(4,'李小帅','13800138002',NULL,1,NULL,0.01,1,'2026-02-27 05:51:49','2026-02-27 05:51:49',0);
/*!40000 ALTER TABLE `clothing_guide` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `clothing_member_level`
--
...
CREATE TABLE `clothing_member_level` (
  ...
  `min_points` int(11) DEFAULT '0' COMMENT 'æœ€ä½Žç§¯åˆ†',
  `max_points` int(11) DEFAULT NULL COMMENT 'æœ€é«˜ç§¯åˆ†ï¼ˆNULLè¡¨ç¤ºæ— ä¸Šé™ï¼‰',
  `discount_rate` decimal(3,2) DEFAULT '1.00' COMMENT 'æŠ˜æ‰£çŽ‡ï¼ˆ0.95è¡¨ç¤º95æŠ˜ï¼‰',
  `points_rate` decimal(3,2) DEFAULT '1.00' COMMENT 'ç§¯åˆ†å€çŽ‡',
  `icon_url` varchar(255) DEFAULT NULL COMMENT 'ç­‰çº§å›¾æ ‡',
  `description` varchar(255) DEFAULT NULL COMMENT 'ç­‰çº§è¯´æ˜Ž',
  `sort_order` int(11) DEFAULT '0' COMMENT 'æŽ’åº',
  `add_time` datetime DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COMMENT='ä¼šå‘˜ç­‰çº§è¡¨';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `clothing_member_level`
--

LOCK TABLES `clothing_member_level` WRITE;
/*!40000 ALTER TABLE `clothing_member_level` DISABLE KEYS */;
INSERT INTO `clothing_member_level` VALUES (9,'普通会员',0,999,1.00,1.00,NULL,'注册即可成为普通会员',1,'2026-02-27 04:11:46','2026-02-27 04:11:46'),(10,'银卡会员',1000,4999,0.98,1.20,NULL,'累计积分达到1000自动升级',2,'2026-02-27 04:11:46','2026-02-27 04:11:46'),(11,'金卡会员',5000,19999,0.95,1.50,NULL,'累计积分达到5000自动升级',3,'2026-02-27 04:11:46','2026-02-27 04:11:46'),(12,'钻石会员',20000,NULL,0.90,2.00,NULL,'累计积分达到20000自动升级',4,'2026-02-27 04:11:46','2026-02-27 04:11:46');
/*!40000 ALTER TABLE `clothing_member_level` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `clothing_points_log`
--

DROP TABLE IF EXISTS `clothing_points_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `clothing_points_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT 'ç”¨æˆ·ID',
  `points` int(11) NOT NULL COMMENT 'ç§¯åˆ†å˜åŠ¨ï¼ˆæ­£æ•°å¢žåŠ ï¼Œè´Ÿæ•°å‡å°‘ï¼‰',
  `type` varchar(20) NOT NULL COMMENT 'ç±»åž‹ï¼šorder_buy/order_comment/exchange/expire',
  `order_id` int(11) DEFAULT NULL COMMENT 'å…³è”è®¢å•ID',
  `remark` varchar(255) DEFAULT NULL COMMENT 'å¤‡æ³¨',
  `balance_after` int(11) DEFAULT NULL COMMENT 'å˜åŠ¨åŽç§¯åˆ†ä½™é¢',
  `add_time` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_user_id` (`user_id`),
  KEY `idx_add_time` (`add_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='ç§¯åˆ†æµæ°´è¡¨';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `clothing_points_log`
--

LOCK TABLES `clothing_points_log` WRITE;
/*!40000 ALTER TABLE `clothing_points_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `clothing_points_log` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `clothing_size` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) NOT NULL COMMENT 'å°ºç åç§°ï¼šS/M/L/XL/XXL',
  `display_name` varchar(50) DEFAULT NULL COMMENT 'æ˜¾ç¤ºåç§°ï¼šå°ç /ä¸­ç /å¤§ç ',
  `sort_order` int(11) DEFAULT '0' COMMENT 'æŽ’åº',
  `enabled` tinyint(1) DEFAULT '1' COMMENT 'æ˜¯å¦å¯ç”¨',
  `add_time` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COMMENT='å°ºç é…ç½®è¡¨';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `clothing_size` VALUES (15,'XS','加小码',1,1,'2026-02-27 04:11:46'),(16,'S','小码',2,1,'2026-02-27 04:11:46'),(17,'M','中码',3,1,'2026-02-27 04:11:46'),(18,'L','大码',4,1,'2026-02-27 04:11:46'),(19,'XL','加大码',5,1,'2026-02-27 04:11:46'),(20,'XXL','特大码',6,1,'2026-02-27 04:11:46'),(21,'XXXL','超大码',7,1,'2026-02-27 04:11:46');
...
CREATE TABLE `clothing_store` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL COMMENT 'é—¨åº—åç§°',
  ...
  `image_url` varchar(255) DEFAULT NULL COMMENT 'é—¨åº—å›¾ç‰‡',
  `status` tinyint(1) DEFAULT '1' COMMENT 'çŠ¶æ€ï¼š0å…³é—­ 1è¥ä¸š',
  `add_time` datetime DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `deleted` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='é—¨åº—è¡¨';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `clothing_store` VALUES (3,'旗舰店','示例市示例区示例路100号','010-12345678','09:00-21:00',116.404000,39.915000,NULL,1,'2026-02-27 04:11:46','2026-02-27 04:11:46',0);
/*!40000 ALTER TABLE `clothing_store` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `clothing_user_body`
--

DROP TABLE IF EXISTS `clothing_user_body`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `clothing_user_body` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT 'ç”¨æˆ·ID',
  `height` int(11) DEFAULT NULL COMMENT 'èº«é«˜(cm)',
  `weight` int(11) DEFAULT NULL COMMENT 'ä½“é‡(kg)',
  `chest` int(11) DEFAULT NULL COMMENT 'èƒ¸å›´(cm)',
  `waist` int(11) DEFAULT NULL COMMENT 'è…°å›´(cm)',
  `hip` int(11) DEFAULT NULL COMMENT 'è‡€å›´(cm)',
  `recommended_size` varchar(20) DEFAULT NULL COMMENT 'æŽ¨èå°ºç ',
  `add_time` datetime DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_user_id` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='ç”¨æˆ·èº«æä¿¡æ¯è¡¨';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `clothing_user_body`
--

LOCK TABLES `clothing_user_body` WRITE;
/*!40000 ALTER TABLE `clothing_user_body` DISABLE KEYS */;
/*!40000 ALTER TABLE `clothing_user_body` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `litemall_ad` VALUES (1,'川着transmute 春日系列','/goods/detail?id=1181101','/images/goods/dress.png',1,'川着transmute 春日新品上市 优雅连衣裙',NULL,NULL,1,'2026-03-13 09:31:34','2026-03-13 09:31:34',0),(2,'职场穿搭精选','/goods/detail?id=1181401','/images/goods/suit.png',1,'职场穿搭精选 干练西装外套',NULL,NULL,1,'2026-03-13 09:31:34','2026-03-13 09:31:34',0),(3,'温柔针织系列','/goods/detail?id=1181301','/images/goods/knit.png',1,'温柔针织系列 春日必备',NULL,NULL,1,'2026-03-13 09:31:34','2026-03-13 09:31:34',0);
...
CREATE TABLE `litemall_address` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COMMENT='收货地址表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `litemall_address` VALUES (2,'张三',1,'北京市','北京市','朝阳区','建国路88号SOHO现代城A座1001','110105','100022','13800138001',1,'2026-02-27 09:40:34','2026-02-27 09:40:34',0),(3,'李四',2,'上海市','上海市','浦东新区','陆家嘴环路1000号恒生银行大厦','310115','200120','13800138002',1,'2026-02-27 09:40:34','2026-02-27 09:40:34',0),(4,'王芳',3,'广东省','深圳市','南山区','科技园南区高新南一道008号','440305','518057','13800138003',1,'2026-02-27 09:40:34','2026-02-27 09:40:34',0),(5,'赵六',4,'浙江省','杭州市','西湖区','文三路398号东信大厦','330106','310013','13800138004',1,'2026-02-27 09:40:34','2026-02-27 09:40:34',0),(6,'孙丽',5,'江苏省','南京市','鼓楼区','中山北路88号','320106','210008','13800138005',1,'2026-02-27 09:40:34','2026-02-27 09:40:34',0),(7,'周杰',6,'四川省','成都市','武侯区','天府大道中段500号','510107','610041','13800138006',1,'2026-02-27 09:40:34','2026-02-27 09:40:34',0),(8,'吴敏',7,'湖北省','武汉市','洪山区','光谷大道77号','420111','430074','13800138007',1,'2026-02-27 09:40:34','2026-02-27 09:40:34',0),(9,'郑伟',8,'山东省','青岛市','市南区','香港中路100号','370202','266071','13800138008',1,'2026-02-27 09:40:34','2026-02-27 09:40:34',0),(10,'陈静',9,'福建省','厦门市','思明区','软件园二期望海路10号','350203','361008','13800138009',1,'2026-02-27 09:40:34','2026-02-27 09:40:34',0),(11,'刘洋',10,'陕西省','西安市','雁塔区','高新路52号','610113','710075','13800138010',1,'2026-02-27 09:40:34','2026-02-27 09:40:34',0),(12,'张三',1,'北京市','北京市','朝阳区','建国路88号SOHO现代城A座1001','110105','100022','13800138001',1,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(13,'李四',2,'上海市','上海市','浦东新区','陆家嘴环路1000号恒生银行大厦','310115','200120','13800138002',1,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(14,'王芳',3,'广东省','深圳市','南山区','科技园南区高新南一道008号','440305','518057','13800138003',1,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(15,'赵六',4,'浙江省','杭州市','西湖区','文三路398号东信大厦','330106','310013','13800138004',1,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(16,'孙丽',5,'江苏省','南京市','鼓楼区','中山北路88号','320106','210008','13800138005',1,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(17,'周杰',6,'四川省','成都市','武侯区','天府大道中段500号','510107','610041','13800138006',1,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(18,'吴敏',7,'湖北省','武汉市','洪山区','光谷大道77号','420111','430074','13800138007',1,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(19,'郑伟',8,'山东省','青岛市','市南区','香港中路100号','370202','266071','13800138008',1,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(20,'陈静',9,'福建省','厦门市','思明区','软件园二期望海路10号','350203','361008','13800138009',1,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(21,'刘洋',10,'陕西省','西安市','雁塔区','高新路52号','610113','710075','13800138010',1,'2026-02-27 09:44:36','2026-02-27 09:44:36',0);
...
INSERT INTO `litemall_admin` VALUES (1,'admin123','$2a$10$.rEfyBb/GURD9P2p0fRg/OAJGloGNDkJS4lY0cQHeqDgsbdTylBpu','127.0.0.1','2026-03-13 16:24:18','https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif','2018-02-01 00:00:00','2026-03-13 16:24:18',0,'[1]'),(4,'promotion123','$2a$10$wDZLOLLnzZ1EFZ3ldZ1XFOUWDEX6TnQCUFdJz4g.PoMaLTzS8TjWq','',NULL,'https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif','2019-01-07 15:16:59','2019-01-07 15:17:34',0,'[3]'),(5,'mall123','$2a$10$aCtsc4rG6KmxQ59.IkYse.oRyKuwQoU2CPCmxSdB.d5nXq6aw/z4O','',NULL,'https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif','2019-01-07 15:17:25','2019-01-07 15:21:05',0,'[2]');
...
CREATE TABLE `litemall_aftersale` (
  ...
  `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='售后表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `litemall_aftersale` VALUES (2,'AS202602270001',1,1,1,'商品质量问题',99.00,'[]','T恤有破洞',1,'2026-02-21 09:53:27','2026-02-20 09:53:27','2026-02-27 09:53:27',0),(3,'AS202602270002',3,3,2,'尺码不合适',499.00,'[]','羽绒服太小了',0,NULL,'2026-02-25 09:53:27','2026-02-27 09:53:27',0),(4,'AS202602270003',5,5,1,'不喜欢',399.00,'[]','颜色和图片不一样',2,'2026-02-26 09:53:27','2026-02-26 09:53:27','2026-02-27 09:53:27',0);
...
INSERT INTO `litemall_brand` VALUES (1000001,'川着transmute','川着transmute精品女装','',1,299.00,'2026-03-13 08:34:52','2026-03-13 08:34:52',0);
...
CREATE TABLE `litemall_cart` (
  ...
  `size` varchar(20) DEFAULT NULL COMMENT 'å°ºç ',
...
CREATE TABLE `litemall_category` (
  ...
  PRIMARY KEY (`id`),
  KEY `parent_id` (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=1022001 DEFAULT CHARSET=utf8mb4 COMMENT='类目表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `litemall_category` VALUES (1000000,'女装','女装,女士服装','女装专区',0,NULL,NULL,'L1',1,NULL,NULL,0),(1010100,'T恤/衬衫','T恤,衬衫,雪纺衫','T恤与衬衫',1000000,'','','L2',1,NULL,NULL,0),(1010200,'针织衫/毛衣','针织衫,毛衣,开衫','针织衫与毛衣',1000000,'','','L2',2,NULL,NULL,0),(1010300,'西装/小香风','西装,小香风,职业装','西装与小香风',1000000,'','','L2',3,NULL,NULL,0),(1011100,'半身裙','半身裙,短裙,中裙,长裙','半身裙',1000000,'','','L2',5,NULL,NULL,0),(1011200,'裤装','西裤,阔腿裤,牛仔裤,休闲裤','裤装',1000000,'','','L2',6,NULL,NULL,0),(1012000,'连衣裙','连衣裙,长裙,短裙','连衣裙',1000000,NULL,NULL,'L2',3,NULL,NULL,0),(1013000,'外套','大衣,风衣,羽绒服,夹克','女士外套',1000000,NULL,NULL,'L2',4,NULL,NULL,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COMMENT='收藏表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `litemall_collect` VALUES (1,1,1181006,0,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(2,1,1181008,0,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(3,2,1181005,0,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(4,3,1181004,0,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(5,3,1181007,0,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(6,4,1181006,0,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(7,5,1181008,0,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(8,6,1181005,0,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(9,7,1181004,0,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(10,8,1181007,0,'2026-02-27 09:44:36','2026-02-27 09:44:36',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=1022 DEFAULT CHARSET=utf8mb4 COMMENT='评论表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `litemall_comment` VALUES (1012,1181004,0,'质量很好，面料舒适，穿着很舒服，推荐购买！','感谢您的支持与认可！',1,0,NULL,5,'2026-02-20 09:44:36','2026-02-27 09:44:36',0),(1013,1181004,0,'颜色和图片一样，没有色差，尺码标准。','',2,0,NULL,4,'2026-02-21 09:44:36','2026-02-27 09:44:36',0),(1014,1181005,0,'牛仔裤版型很好，显瘦，做工精细。','感谢您的认可！',3,0,NULL,5,'2026-02-22 09:44:36','2026-02-27 09:44:36',0),(1015,1181005,0,'面料有点硬，洗过之后好一些了。','牛仔面料新衣会稍硬，感谢反馈！',4,0,NULL,3,'2026-02-23 09:44:36','2026-02-27 09:44:36',0),(1016,1181006,0,'羽绒服很轻便，保暖效果不错，冬天穿正合适。','感谢您的支持！',5,0,NULL,5,'2026-02-24 09:44:36','2026-02-27 09:44:36',0),(1017,1181006,0,'颜色比图片深一点，不过也很好看。','',6,0,NULL,4,'2026-02-25 09:44:36','2026-02-27 09:44:36',0),(1018,1181007,0,'衬衫面料很舒服，透气性好，夏天穿很凉快。','感谢您的评价！',7,0,NULL,5,'2026-02-25 09:44:36','2026-02-27 09:44:36',0),(1019,1181007,0,'尺码偏小，建议买大一号。','感谢您的反馈！',8,0,NULL,3,'2026-02-26 09:44:36','2026-02-27 09:44:36',0),(1020,1181008,0,'风衣版型很好看，穿上很有气质，质量也很好。','',9,0,NULL,5,'2026-02-26 09:44:36','2026-02-27 09:44:36',0),(1021,1181008,0,'卡其色很百搭，适合各种场合穿。','感谢您的认可！',10,0,NULL,5,'2026-02-27 09:44:36','2026-02-27 09:44:36',0);
...
CREATE TABLE `litemall_feedback` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_value` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='意见反馈表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `litemall_feedback` VALUES (1,1,'张三','13800138001','功能建议','希望增加商品收藏夹分类功能。',0,0,NULL,'2026-02-22 09:44:36','2026-02-27 09:44:36',0),(2,3,'王芳','13800138003','问题反馈','APP偶尔会闪退。',0,0,NULL,'2026-02-24 09:44:36','2026-02-27 09:44:36',0),(3,5,'孙丽','13800138005','投诉','订单发货太慢了。',1,0,NULL,'2026-02-25 09:44:36','2026-02-27 09:44:36',0),(4,7,'吴敏','13800138007','功能建议','建议增加夜间模式。',0,0,NULL,'2026-02-26 09:44:36','2026-02-27 09:44:36',0),(5,9,'陈静','13800138009','表扬','客服服务态度很好！',1,0,NULL,'2026-02-27 09:44:36','2026-02-27 09:44:36',0);
...
CREATE TABLE `litemall_footprint` (
  ...
  `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COMMENT='用户浏览足迹表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `litemall_footprint` VALUES (1,1,1181004,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(2,1,1181005,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(3,1,1181006,'2026-02-26 09:44:36','2026-02-27 09:44:36',0),(4,2,1181005,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(5,2,1181007,'2026-02-26 09:44:36','2026-02-27 09:44:36',0),(6,3,1181006,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(7,3,1181008,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(8,4,1181004,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(9,5,1181008,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(10,6,1181005,'2026-02-27 09:44:36','2026-02-27 09:44:36',0);
...
CREATE TABLE `litemall_goods` (
  ...
  `season` varchar(20) DEFAULT NULL COMMENT 'å­£èŠ‚ï¼šspring/summer/autumn/winter/all_season',
  `style` varchar(50) DEFAULT NULL COMMENT 'é£Žæ ¼æ ‡ç­¾',
  `material` varchar(100) DEFAULT NULL COMMENT 'æè´¨',
  `size_table` text COMMENT 'å°ºç è¡¨JSON',
...
) ENGINE=InnoDB AUTO_INCREMENT=1181702 DEFAULT CHARSET=utf8mb4 COMMENT='商品基本信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `litemall_goods` VALUES (1181101,'DRESS001','春日优雅连衣裙',1012000,1000001,'[\"/images/goods/dress.png\"]',NULL,NULL,NULL,NULL,'连衣裙,春日,优雅','春日优雅连衣裙，柔和米白色调，简约高级感',1,100,'/images/goods/dress.png','',0,0,'’件‘',699.00,399.00,'<p>春日优雅连衣裙，柔和米白色调，简约高级感，适合约会、聚会、通勤等多种场合</p>','2026-03-13 09:24:20','2026-03-13 09:24:20',0),(1181201,'SHIRT001','法式雪纺衬衫',1010100,1000001,'[\"/images/goods/shirt.png\"]',NULL,NULL,NULL,NULL,'衬衫,法式,雪纺','法式雪纺衬衫。\n温柔知性。春日必备',1,99,'/images/goods/shirt.png','',0,0,'’件‘',399.00,199.00,'<p>法式雪纺衬衫。\n温柔知性。\n百搭款式。春日必备单品</p>','2026-03-13 09:24:20','2026-03-13 09:24:20',0),(1181301,'KNIT001','温柔针织开衫',1010200,1000001,'[\"/images/goods/knit.png\"]',NULL,NULL,NULL,NULL,'针织衫,开衫,温柔','温柔针织开衫。\n春秋百搭外套',1,98,'/images/goods/knit.png','',0,0,'’件‘',459.00,259.00,'<p>温柔针织开衫。\n春秋百搭外套。柔软舒适</p>','2026-03-13 09:24:20','2026-03-13 09:24:20',0),(1181401,'SUIT001','干练西装外套',1010300,1000001,'[\"/images/goods/suit.png\"]',NULL,NULL,NULL,NULL,'西装,外套,干练','干练西装外套。\n职场气场必备',1,97,'/images/goods/suit.png','',0,0,'’件‘',899.00,499.00,'<p>干练西装外套。\n职场气场必备。简约大气</p>','2026-03-13 09:24:20','2026-03-13 09:24:20',0),(1181501,'COAT001','经典风衣外套',1013000,1000001,'[\"/images/goods/coat.png\"]',NULL,NULL,NULL,NULL,'风衣,外套,经典','经典风衣外套。\n优雅气质',1,96,'/images/goods/coat.png','',0,0,'’件‘',999.00,599.00,'<p>经典风衣外套。\n优雅气质。春秋必备</p>','2026-03-13 09:24:20','2026-03-13 09:24:20',0),(1181601,'SKIRT001','A字半身裙',1011100,1000001,'[\"/images/goods/skirt.png\"]',NULL,NULL,NULL,NULL,'半身裙,A字,显瘦','A字半身裙。\n显瘦百搭',1,95,'/images/goods/skirt.png','',0,0,'’件‘',359.00,199.00,'<p>A字半身裙。\n显瘦百搭。通勤休闲两相宜</p>','2026-03-13 09:24:20','2026-03-13 09:24:20',0),(1181701,'PANTS001','高腰阔腿裤',1011200,1000001,'[\"/images/goods/pants.png\"]',NULL,NULL,NULL,NULL,'阔腿裤,高腰,显瘦','高腰阔腿裤。\n显瘦显高',1,94,'/images/goods/pants.png','',0,0,'’件‘',459.00,259.00,'<p>高腰阔腿裤。\n显瘦显高。职场通勤必备</p>','2026-03-13 09:24:20','2026-03-13 09:24:20',0);
...
CREATE TABLE `litemall_goods_product` (
  ...
  PRIMARY KEY (`id`),
  KEY `goods_id` (`goods_id`)
) ENGINE=InnoDB AUTO_INCREMENT=285 DEFAULT CHARSET=utf8mb4 COMMENT='商品货品表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `litemall_goods_specification` (
  ...
  PRIMARY KEY (`id`),
  KEY `goods_id` (`goods_id`)
) ENGINE=InnoDB AUTO_INCREMENT=276 DEFAULT CHARSET=utf8mb4 COMMENT='商品规格表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `litemall_issue` (
  ...
  `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COMMENT='常见问题表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `litemall_issue` VALUES (5,'如何选择合适的尺码？','建议您参考商品详情页的尺码表，根据您的身高体重选择合适的尺码。','2026-02-27 09:44:36','2026-02-27 09:44:36',0),(6,'支持哪些支付方式？','我们支持微信支付、支付宝、银联卡等多种支付方式。','2026-02-27 09:44:36','2026-02-27 09:44:36',0),(7,'发货后多久能收到？','一般订单发货后1-3个工作日可送达。','2026-02-27 09:44:36','2026-02-27 09:44:36',0),(8,'如何申请退换货？','在\"我的订单\"中找到需要售后的订单，点击\"申请售后\"即可。','2026-02-27 09:44:36','2026-02-27 09:44:36',0),(9,'会员有什么优惠？','会员可享受专属折扣、积分抵现、优先发货等特权。','2026-02-27 09:44:36','2026-02-27 09:44:36',0);
...
CREATE TABLE `litemall_log` (
  ...
  `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=61 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='操作日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `litemall_log` VALUES (43,'匿名用户','127.0.0.1',1,'登录',0,'用户帐号或密码不正确','','2026-02-27 11:37:50','2026-02-27 11:37:50',0),(44,'admin123','127.0.0.1',1,'登录',1,'','','2026-02-27 11:50:44','2026-02-27 11:50:44',0),(45,'admin123','127.0.0.1',1,'登录',1,'','','2026-02-27 11:53:54','2026-02-27 11:53:54',0),(46,'admin123','127.0.0.1',1,'登录',1,'','','2026-02-27 11:54:40','2026-02-27 11:54:40',0),(47,'admin123','127.0.0.1',1,'登录',1,'','','2026-02-27 12:09:03','2026-02-27 12:09:03',0),(48,'admin123','127.0.0.1',1,'登录',1,'','','2026-02-27 12:12:26','2026-02-27 12:12:26',0),(49,'admin123','127.0.0.1',1,'登录',1,'','','2026-02-27 12:13:21','2026-02-27 12:13:21',0),(50,'admin123','127.0.0.1',1,'登录',1,'','','2026-02-27 12:40:23','2026-02-27 12:40:23',0),(51,'admin123','127.0.0.1',1,'登录',1,'','','2026-02-27 12:41:27','2026-02-27 12:41:27',0),(52,'admin123','127.0.0.1',1,'登录',1,'','','2026-02-27 12:45:17','2026-02-27 12:45:17',0),(53,'admin123','127.0.0.1',1,'登录',1,'','','2026-02-27 12:46:14','2026-02-27 12:46:14',0),(54,'admin123','127.0.0.1',1,'登录',1,'','','2026-02-27 12:51:39','2026-02-27 12:51:39',0),(55,'admin123','127.0.0.1',1,'登录',1,'','','2026-02-27 13:53:51','2026-02-27 13:53:51',0),(56,'admin123','127.0.0.1',1,'登录',1,'','','2026-02-27 13:54:45','2026-02-27 13:54:45',0),(57,'匿名用户','0:0:0:0:0:0:0:1',1,'登录',0,'用户帐号或密码不正确','','2026-03-13 16:04:54','2026-03-13 16:04:54',0),(58,'admin','0:0:0:0:0:0:0:1',1,'登录',1,'','','2026-03-13 16:05:23','2026-03-13 16:05:23',0),(59,'admin123','0:0:0:0:0:0:0:1',1,'登录',1,'','','2026-03-13 16:15:40','2026-03-13 16:15:40',0),(60,'admin123','127.0.0.1',1,'登录',1,'','','2026-03-13 16:24:18','2026-03-13 16:24:18',0);
...
CREATE TABLE `litemall_order` (
  ...
  `delivery_type` varchar(20) DEFAULT 'express' COMMENT 'é…é€æ–¹å¼ï¼šexpresså¿«é€’/pickupè‡ªæ',
  `pickup_store_id` int(11) DEFAULT NULL COMMENT 'è‡ªæé—¨åº—ID',
  `pickup_contact` varchar(50) DEFAULT NULL COMMENT 'è‡ªæè”ç³»äºº',
  `pickup_phone` varchar(20) DEFAULT NULL COMMENT 'è‡ªæè”ç³»ç”µè¯',
  `pickup_time` datetime DEFAULT NULL COMMENT 'é¢„çº¦è‡ªææ—¶é—´',
  `pickup_code` varchar(20) DEFAULT NULL COMMENT 'å–è´§ç ',
  `pickup_status` tinyint(1) DEFAULT '0' COMMENT 'è‡ªæçŠ¶æ€ï¼š0å¾…è‡ªæ 1å·²è‡ªæ',
...
INSERT INTO `litemall_order` VALUES (1,1,'202602270001',401,0,'张三','13800138001','北京市朝阳区建国路88号','尽快发货',298.00,0.00,'express',NULL,NULL,NULL,NULL,NULL,0,1,0.00,0.00,0.00,298.00,298.00,'PAY001','2026-02-17 09:44:36','SF1234567890','顺丰速运','2026-02-18 09:44:36',NULL,NULL,NULL,NULL,'2026-02-20 09:44:36',0,NULL,'2026-02-17 09:44:36','2026-02-27 09:44:36',0),(2,2,'202602270002',401,0,'李四','13800138002','上海市浦东新区陆家嘴','',199.00,0.00,'express',NULL,NULL,NULL,NULL,NULL,0,1,0.00,0.00,0.00,199.00,199.00,'PAY002','2026-02-19 09:44:36','SF1234567891','顺丰速运','2026-02-20 09:44:36',NULL,NULL,NULL,NULL,'2026-02-22 09:44:36',0,NULL,'2026-02-19 09:44:36','2026-02-27 09:44:36',0),(3,3,'202602270003',401,0,'王芳','13800138003','深圳市南山区科技园','周末配送',498.00,0.00,'express',NULL,NULL,NULL,NULL,NULL,0,2,10.00,0.00,0.00,498.00,488.00,'PAY003','2026-02-21 09:44:36','YT9876543210','圆通快递','2026-02-22 09:44:36',NULL,NULL,NULL,NULL,'2026-02-24 09:44:36',0,NULL,'2026-02-21 09:44:36','2026-02-27 09:44:36',0),(4,4,'202602270004',301,0,'赵六','13800138004','杭州市西湖区文三路','',159.00,0.00,'express',NULL,NULL,NULL,NULL,NULL,0,NULL,0.00,0.00,0.00,159.00,159.00,'PAY004','2026-02-24 09:44:36','ZTO1122334455','中通快递','2026-02-25 09:44:36',NULL,NULL,NULL,NULL,NULL,0,NULL,'2026-02-24 09:44:36','2026-02-27 09:44:36',0),(5,5,'202602270005',301,0,'孙丽','13800138005','南京市鼓楼区中山北路','易碎物品',399.00,10.00,'express',NULL,NULL,NULL,NULL,NULL,0,1,20.00,0.00,0.00,409.00,389.00,'PAY005','2026-02-25 09:44:36','JD5566778899','京东快递','2026-02-26 09:44:36',NULL,NULL,NULL,NULL,NULL,0,NULL,'2026-02-25 09:44:36','2026-02-27 09:44:36',0),(6,6,'202602270006',201,0,'周杰','13800138006','成都市武侯区天府大道','',658.00,0.00,'express',NULL,NULL,NULL,NULL,NULL,0,2,0.00,50.00,0.00,658.00,608.00,'PAY006','2026-02-26 09:44:36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,'2026-02-26 09:44:36','2026-02-27 09:44:36',0),(7,7,'202602270007',201,0,'吴敏','13800138007','武汉市洪山区光谷大道','',99.00,10.00,'express',NULL,NULL,NULL,NULL,NULL,0,NULL,0.00,0.00,0.00,109.00,109.00,'PAY007','2026-02-27 09:44:36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(8,8,'202602270008',103,0,'郑伟','13800138008','青岛市市南区香港中路','',558.00,0.00,'express',NULL,NULL,NULL,NULL,NULL,0,1,0.00,0.00,0.00,558.00,558.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,'2026-03-13 15:57:05','2026-02-27 09:44:36','2026-03-13 15:57:05',0),(9,9,'202602270009',103,0,'陈静','13800138009','厦门市思明区软件园','包装精美',199.00,0.00,'express',NULL,NULL,NULL,NULL,NULL,0,2,0.00,0.00,0.00,199.00,199.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,'2026-03-13 15:57:06','2026-02-27 09:44:36','2026-03-13 15:57:06',0),(10,10,'202602270010',102,0,'刘洋','13800138010','西安市雁塔区高新路','',499.00,0.00,'express',NULL,NULL,NULL,NULL,NULL,0,1,0.00,0.00,0.00,499.00,499.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(11,1,'202602270011',401,0,'张三','13800138001','北京市朝阳区建国路','',99.00,0.00,'pickup',3,NULL,NULL,NULL,NULL,0,1,0.00,0.00,0.00,99.00,99.00,'PAY011','2026-02-22 09:44:36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2026-02-23 09:44:36',0,NULL,'2026-02-22 09:44:36','2026-02-27 09:44:36',0),(12,3,'202602270012',301,0,'王芳','13800138003','深圳市南山区','',199.00,0.00,'pickup',3,NULL,NULL,NULL,NULL,0,2,0.00,0.00,0.00,199.00,199.00,'PAY012','2026-02-26 09:44:36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,'2026-02-26 09:44:36','2026-02-27 09:44:36',0),(13,5,'202602270013',401,0,'孙丽','13800138005','南京市鼓楼区中山北路','',258.00,0.00,'express',NULL,NULL,NULL,NULL,NULL,0,1,0.00,0.00,0.00,258.00,258.00,'PAY013','2026-02-12 09:44:36','SF9988776655','顺丰速运','2026-02-13 09:44:36',NULL,NULL,NULL,NULL,'2026-02-15 09:44:36',0,NULL,'2026-02-12 09:44:36','2026-02-27 09:44:36',0),(14,6,'202602270014',401,0,'周杰','13800138006','成都市武侯区天府大道','',499.00,0.00,'express',NULL,NULL,NULL,NULL,NULL,0,2,0.00,0.00,0.00,499.00,499.00,'PAY014','2026-02-07 09:44:36','EMS112233445','EMS','2026-02-09 09:44:36',NULL,NULL,NULL,NULL,'2026-02-12 09:44:36',0,NULL,'2026-02-07 09:44:36','2026-02-27 09:44:36',0),(15,8,'202602270015',401,0,'郑伟','13800138008','青岛市市南区香港中路','',399.00,0.00,'express',NULL,NULL,NULL,NULL,NULL,0,1,0.00,0.00,0.00,399.00,399.00,'PAY015','2026-02-15 09:44:36','YD5544332211','韵达快递','2026-02-16 09:44:36',NULL,NULL,NULL,NULL,'2026-02-19 09:44:36',0,NULL,'2026-02-15 09:44:36','2026-02-27 09:44:36',0);
...
INSERT INTO `litemall_order_goods` VALUES (1,1,1181004,'简约纯色T恤','TSHIRT001',1,NULL,NULL,NULL,1,99.00,'[\"白色\", \"M\"]','',1,'2026-02-17 09:44:36','2026-02-27 09:44:36',0),(2,1,1181005,'休闲牛仔裤','JEANS001',5,NULL,NULL,NULL,1,199.00,'[\"深蓝\", \"28\"]','',0,'2026-02-17 09:44:36','2026-02-27 09:44:36',0),(3,2,1181005,'休闲牛仔裤','JEANS001',6,NULL,NULL,NULL,1,199.00,'[\"深蓝\", \"30\"]','',1,'2026-02-19 09:44:36','2026-02-27 09:44:36',0),(4,3,1181006,'轻薄羽绒服','JACKET001',9,NULL,NULL,NULL,1,499.00,'[\"黑色\", \"M\"]','',1,'2026-02-21 09:44:36','2026-02-27 09:44:36',0),(5,4,1181007,'商务休闲衬衫','SHIRT001',13,NULL,NULL,NULL,1,159.00,'[\"卡其色\", \"M\"]','',0,'2026-02-24 09:44:36','2026-02-27 09:44:36',0),(6,5,1181008,'经典风衣外套','COAT001',16,NULL,NULL,NULL,1,399.00,'[\"黑色\", \"L\"]','',0,'2026-02-25 09:44:36','2026-02-27 09:44:36',0),(7,6,1181006,'轻薄羽绒服','JACKET001',10,NULL,NULL,NULL,1,499.00,'[\"白色\", \"L\"]','',0,'2026-02-26 09:44:36','2026-02-27 09:44:36',0),(8,6,1181004,'简约纯色T恤','TSHIRT001',2,NULL,NULL,NULL,2,99.00,'[\"黑色\", \"M\"]','',0,'2026-02-26 09:44:36','2026-02-27 09:44:36',0),(9,7,1181004,'简约纯色T恤','TSHIRT001',3,NULL,NULL,NULL,1,99.00,'[\"卡其色\", \"M\"]','',0,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(10,8,1181008,'经典风衣外套','COAT001',16,NULL,NULL,NULL,1,399.00,'[\"白色\", \"L\"]','',0,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(11,8,1181007,'商务休闲衬衫','SHIRT001',14,NULL,NULL,NULL,1,159.00,'[\"浅蓝\", \"28\"]','',0,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(12,9,1181005,'休闲牛仔裤','JEANS001',7,NULL,NULL,NULL,1,199.00,'[\"白色\", \"M\"]','',0,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(13,10,1181006,'轻薄羽绒服','JACKET001',11,NULL,NULL,NULL,1,499.00,'[\"白色\", \"M\"]','',0,'2026-02-27 09:44:36','2026-02-27 09:44:36',0),(14,11,1181004,'简约纯色T恤','TSHIRT001',1,NULL,NULL,NULL,1,99.00,'[\"浅蓝\", \"30\"]','',1,'2026-02-22 09:44:36','2026-02-27 09:44:36',0),(15,12,1181005,'休闲牛仔裤','JEANS001',8,NULL,NULL,NULL,1,199.00,'[\"白色\", \"M\"]','',0,'2026-02-26 09:44:36','2026-02-27 09:44:36',0),(16,13,1181007,'商务休闲衬衫','SHIRT001',13,NULL,NULL,NULL,1,159.00,'[\"白色\", \"L\"]','',1,'2026-02-12 09:44:36','2026-02-27 09:44:36',0),(17,13,1181004,'简约纯色T恤','TSHIRT001',2,NULL,NULL,NULL,1,99.00,'[\"黑色\", \"M\"]','',0,'2026-02-12 09:44:36','2026-02-27 09:44:36',0),(18,14,1181006,'轻薄羽绒服','JACKET001',9,NULL,NULL,NULL,1,499.00,'[\"黑色\", \"M\"]','',1,'2026-02-07 09:44:36','2026-02-27 09:44:36',0),(19,15,1181008,'经典风衣外套','COAT001',17,NULL,NULL,NULL,1,399.00,'[\"黑色\", \"M\"]','',1,'2026-02-15 09:44:36','2026-02-27 09:44:36',0);
...
INSERT INTO `litemall_system` VALUES (19,'litemall_order_unpaid','30','2026-02-27 11:30:58','2026-02-27 11:30:58',0),(20,'litemall_wx_index_new','7','2026-02-27 11:30:58','2026-02-27 11:30:58',0),(21,'litemall_mall_latitude','31.201900','2026-02-27 11:30:58','2026-02-27 11:30:58',0),(22,'litemall_order_unconfirm','7','2026-02-27 11:30:58','2026-02-27 11:30:58',0),(23,'litemall_wx_share','false','2026-02-27 11:30:58','2026-02-27 11:30:58',0),(24,'litemall_express_freight_min','88','2026-02-27 11:30:58','2026-02-27 11:30:58',0),(25,'litemall_mall_name','川着transmute','2026-02-27 11:30:58','2026-02-27 11:30:58',0),(26,'litemall_express_freight_value','8','2026-02-27 11:30:58','2026-02-27 11:30:58',0),(27,'litemall_mall_qq','川着客服','2026-02-27 11:30:58','2026-02-27 11:30:58',0),(28,'litemall_wx_index_hot','7','2026-02-27 11:30:58','2026-02-27 11:30:58',0),(29,'litemall_order_comment','7','2026-02-27 11:30:58','2026-02-27 11:30:58',0),(30,'litemall_wx_catlog_goods','4','2026-02-27 11:30:58','2026-02-27 11:30:58',0),(31,'litemall_mall_longitude','121.587839','2026-02-27 11:30:58','2026-02-27 11:30:58',0),(32,'litemall_mall_phone','400-888-8888','2026-02-27 11:30:58','2026-02-27 11:30:58',0),(33,'litemall_wx_catlog_list','4','2026-02-27 11:30:58','2026-02-27 11:30:58',0),(34,'litemall_mall_address','杭州市','2026-02-27 11:30:58','2026-02-27 11:30:58',0),(35,'litemall_wx_index_brand','1','2026-02-27 11:30:58','2026-02-27 11:30:58',0),(36,'litemall_wx_index_topic','4','2026-02-27 11:30:58','2026-02-27 11:30:58',0);
...
CREATE TABLE `litemall_topic` (
  ...
  PRIMARY KEY (`id`),
  KEY `topic_id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=405 DEFAULT CHARSET=utf8mb4 COMMENT='专题表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `litemall_topic` VALUES (401,'川着transmute 春日穿搭指南','2026春夏流行趋势','<p>川着transmute为你带来2026春夏最新流行趋势。从优雅连衣裙到干练西装，让你轻松驾驭各种场合。</p><p><img src=\"/images/goods/dress.png\" style=\"width:100%\"/></p>',0.00,'3256','/images/goods/dress.png',1,'','2026-03-13 09:32:01','2026-03-13 09:32:01',0),(402,'职场女性穿搭攻略','穿出专业范儿，展现自信魅力','<p>职场穿搭不仅仅是着装，更是展现专业态度和个人魅力的重要方式。川着transmute精选西装、衬衫、裤装，助你打造完美职场形象。</p><p><img src=\"/images/goods/suit.png\" style=\"width:100%\"/></p>',0.00,'2086','/images/goods/suit.png',2,'','2026-03-13 09:32:01','2026-03-13 09:32:01',0),(403,'约会穿搭灵感','浪漫约会。从穿搭开始','<p>约会穿什么？川着transmute为你精选浪漫连衣裙、温柔针织衫，让你在约会中展现最美的一面。</p><p><img src=\"/images/goods/knit.png\" style=\"width:100%\"/></p>',0.00,'2580','/images/goods/knit.png',3,'','2026-03-13 09:32:01','2026-03-13 09:32:01',0),(404,'基础款穿搭技巧','基础款也能穿出高级感','<p>白T恤、牛仔裤、小黑裙...这些基础款如何穿出高级感？川着transmute教你搭配技巧，让简约成为你的风格标签。</p><p><img src=\"/images/goods/shirt.png\" style=\"width:100%\"/></p>',0.00,'3345','/images/goods/shirt.png',4,'','2026-03-13 09:32:01','2026-03-13 09:32:01',0);
...
CREATE TABLE `litemall_user` (
  ...
  `level_id` int(11) DEFAULT NULL COMMENT 'ä¼šå‘˜ç­‰çº§ID',
  `total_points` int(11) DEFAULT '0' COMMENT 'ç´¯è®¡ç§¯åˆ†',
  `available_points` int(11) DEFAULT '0' COMMENT 'å¯ç”¨ç§¯åˆ†',
  `guide_id` int(11) DEFAULT NULL COMMENT 'ç»‘å®šå¯¼è´­ID',
  `store_id` int(11) DEFAULT NULL COMMENT 'å½’å±žé—¨åº—ID',
...
INSERT INTO `litemall_user` VALUES (1,'user001','e10adc3949ba59abbe56e057f20f883e',1,'1990-05-15','2026-02-27 09:35:35','192.168.1.100',2,'???','13800138001',2,1200,800,1,3,'https://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTK7rPEqO2S9A7p3zUrWwSvz9FClQIricRiaOqFQ0nJ3IjxYPnJXPKKPjOGqL5F5YgM4kEAG6sXqhkAg/132','','',0,'2026-02-27 09:35:35','2026-02-27 09:35:35',0),(2,'user002','e10adc3949ba59abbe56e057f20f883e',2,'1992-08-20','2026-02-27 09:35:35','192.168.1.101',1,'???','13800138002',1,500,300,1,3,'','','',0,'2026-02-27 09:35:35','2026-02-27 09:35:35',0),(3,'user003','e10adc3949ba59abbe56e057f20f883e',2,'1995-03-10','2026-02-27 09:35:35','192.168.1.102',2,'???','13800138003',2,2000,1500,2,3,'','','',0,'2026-02-27 09:35:35','2026-02-27 09:35:35',0),(4,'user004','e10adc3949ba59abbe56e057f20f883e',1,'1988-11-25','2026-02-27 09:35:35','192.168.1.103',0,'???','13800138004',0,100,100,NULL,3,'','','',0,'2026-02-27 09:35:35','2026-02-27 09:35:35',0),(5,'user005','e10adc3949ba59abbe56e057f20f883e',2,'1993-07-08','2026-02-27 09:35:35','192.168.1.104',1,'???','13800138005',1,800,600,1,3,'','','',0,'2026-02-27 09:35:35','2026-02-27 09:35:35',0),(6,'user006','e10adc3949ba59abbe56e057f20f883e',1,'1991-02-14','2026-02-27 09:35:35','192.168.1.105',2,'???','13800138006',3,3500,2000,2,3,'','','',0,'2026-02-27 09:35:35','2026-02-27 09:35:35',0),(7,'user007','e10adc3949ba59abbe56e057f20f883e',2,'1996-09-30','2026-02-27 09:35:35','192.168.1.106',0,'???','13800138007',0,50,50,NULL,3,'','','',0,'2026-02-27 09:35:35','2026-02-27 09:35:35',0),(8,'user008','e10adc3949ba59abbe56e057f20f883e',1,'1989-04-18','2026-02-27 09:35:35','192.168.1.107',1,'???','13800138008',1,600,400,1,3,'','','',0,'2026-02-27 09:35:35','2026-02-27 09:35:35',0),(9,'user009','e10adc3949ba59abbe56e057f20f883e',2,'1994-12-05','2026-02-27 09:35:35','192.168.1.108',2,'???','13800138009',2,1800,1200,2,3,'','','',0,'2026-02-27 09:35:35','2026-02-27 09:35:35',0),(10,'user010','e10adc3949ba59abbe56e057f20f883e',1,'1990-06-22','2026-02-27 09:35:35','192.168.1.109',1,'???','13800138010',1,900,700,1,3,'','','',0,'2026-02-27 09:35:35','2026-02-27 09:35:35',0);
...
-- Dump completed on 2026-03-13 16:48:16

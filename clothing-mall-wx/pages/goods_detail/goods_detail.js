...
Page({
  data: {
    ...
    // 尺码对照表
    sizeChart: {
      headers: ['尺码', '身高(cm)', '体重(kg)', '胸围(cm)', '腰围(cm)'],
      rows: [
        ['S',  '155-160', '40-50', '78-82', '62-66'],
        ['M',  '160-165', '50-60', '82-86', '66-70'],
        ['L',  '165-170', '60-70', '86-90', '70-74'],
        ['XL', '170-175', '70-80', '90-94', '74-78']
      ]
    }
  },
  ...
  previewGalleryImage(e) {
    ...
    var COS_BASE = 'https://636c-cloudbase-d3g1zmq7r388144eb-1427677265.tcb.qcloud.la/'

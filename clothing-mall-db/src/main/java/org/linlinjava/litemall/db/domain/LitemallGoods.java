...
public class LitemallGoods {
    ...
    /**
     * 商品状态：draft(草稿), pending(待上架), published(已上架)
     */
    ...
    /** 场景标签 JSON 数组，如 ["日常通勤","约会聚餐"] */
    private String sceneTags;

    /** 商品参数 JSON 数组，如 [{"key":"面料","value":"棉麻"}] */
    ...
    public String getGoodsParams() { return goodsParams; }
    public void setGoodsParams(String goodsParams) { this.goodsParams = goodsParams; }
    ...
    public enum Column {
        ...
        sceneTags("scene_tags", "sceneTags", "LONGVARCHAR", false),
        goodsParams("goods_params", "goodsParams", "LONGVARCHAR", false);

...
public class LitemallOrderService {
    ...
    public long countByOrderStatus(List<Short> orderStatus) {
        LitemallOrderExample example = new LitemallOrderExample();
    ...
    public Map<String, Long> getOrderStatusCounts() {
        List<Map> counts = orderMapper.getOrderStatusCounts();
        Map<String, Long> statusCounts = new HashMap<>();
        long total = 0;
        for (Map map : counts) {
            // Check for null values safely
    ...
    public List<LitemallOrder> querySelective(Integer userId, String orderSn, LocalDateTime start, LocalDateTime end,

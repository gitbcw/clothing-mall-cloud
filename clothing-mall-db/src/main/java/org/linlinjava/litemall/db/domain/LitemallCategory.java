...
public class LitemallCategory {
    ...
    /**
     * 季节开关：spring/summer/autumn/winter/all（逗号分隔多选）
     */
    private String seasonSwitch;

    /**
     * 是否启用尺码选择（L1分类设置，L2继承）
     */
    ...
    /**
     * 获取季节开关
     * @return the value of litemall_category.season_switch
     */
    ...
    /**
     * 设置季节开关
     * @param seasonSwitch the value for litemall_category.season_switch
     */
    ...
    public String toString() {
        ...
        sb.append(", seasonSwitch=").append(seasonSwitch);
        sb.append(", enableSize=").append(enableSize);
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getSeasonSwitch() == null ? other.getSeasonSwitch() == null : this.getSeasonSwitch().equals(other.getSeasonSwitch()))
            && (this.getEnableSize() == null ? other.getEnableSize() == null : this.getEnableSize().equals(other.getEnableSize()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSeasonSwitch() == null) ? 0 : getSeasonSwitch().hashCode());
        result = prime * result + ((getEnableSize() == null) ? 0 : getEnableSize().hashCode());
    ...
    public enum Column {
        ...
        seasonSwitch("season_switch", "seasonSwitch", "VARCHAR", true),
        enableSize("enable_size", "enableSize", "BIT", false),

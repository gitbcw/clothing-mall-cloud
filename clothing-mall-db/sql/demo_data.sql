...
-- 1. 用户数据 (10个)
INSERT INTO litemall_user (id, username, password, gender, birthday, last_login_time, last_login_ip, user_level, nickname, mobile, level_id, total_points, available_points, guide_id, store_id, avatar, weixin_openid, session_key, status, add_time, update_time, deleted) VALUES
(1, 'user001', 'e10adc3949ba59abbe56e057f20f883e', 1, '1990-05-15', NOW(), '192.168.1.100', 2, '张三', '13800138001', 2, 1200, 800, 1, 3, 'https://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTK7rPEqO2S9A7p3zUrWwSvz9FClQIricRiaOqFQ0nJ3IjxYPnJXPKKPjOGqL5F5YgM4kEAG6sXqhkAg/132', '', '', 0, NOW(), NOW(), 0),
(2, 'user002', 'e10adc3949ba59abbe56e057f20f883e', 2, '1992-08-20', NOW(), '192.168.1.101', 1, '李四', '13800138002', 1, 500, 300, 1, 3, '', '', '', 0, NOW(), NOW(), 0),
(3, 'user003', 'e10adc3949ba59abbe56e057f20f883e', 2, '1995-03-10', NOW(), '192.168.1.102', 2, '王芳', '13800138003', 2, 2000, 1500, 2, 3, '', '', '', 0, NOW(), NOW(), 0),
(4, 'user004', 'e10adc3949ba59abbe56e057f20f883e', 1, '1988-11-25', NOW(), '192.168.1.103', 0, '赵六', '13800138004', 0, 100, 100, NULL, 3, '', '', '', 0, NOW(), NOW(), 0),
(5, 'user005', 'e10adc3949ba59abbe56e057f20f883e', 2, '1993-07-08', NOW(), '192.168.1.104', 1, '孙丽', '13800138005', 1, 800, 600, 1, 3, '', '', '', 0, NOW(), NOW(), 0),
(6, 'user006', 'e10adc3949ba59abbe56e057f20f883e', 1, '1991-02-14', NOW(), '192.168.1.105', 2, '周杰', '13800138006', 3, 3500, 2000, 2, 3, '', '', '', 0, NOW(), NOW(), 0),
(7, 'user007', 'e10adc3949ba59abbe56e057f20f883e', 2, '1996-09-30', NOW(), '192.168.1.106', 0, '吴敏', '13800138007', 0, 50, 50, NULL, 3, '', '', '', 0, NOW(), NOW(), 0),
(8, 'user008', 'e10adc3949ba59abbe56e057f20f883e', 1, '1989-04-18', NOW(), '192.168.1.107', 1, '郑伟', '13800138008', 1, 600, 400, 1, 3, '', '', '', 0, NOW(), NOW(), 0),
(9, 'user009', 'e10adc3949ba59abbe56e057f20f883e', 2, '1994-12-05', NOW(), '192.168.1.108', 2, '陈静', '13800138009', 2, 1800, 1200, 2, 3, '', '', '', 0, NOW(), NOW(), 0),
(10, 'user010', 'e10adc3949ba59abbe56e057f20f883e', 1, '1990-06-22', NOW(), '192.168.1.109', 1, '刘洋', '13800138010', 1, 900, 700, 1, 3, '', '', '', 0, NOW(), NOW(), 0);

-- 2. 用户地址 (10个)
INSERT INTO litemall_address (id, name, user_id, province, city, county, address_detail, area_code, postal_code, tel, is_default, add_time, update_time, deleted) VALUES
(1, '张三', 1, '北京市', '北京市', '朝阳区', '建国路88号SOHO现代城A座1001', '110105', '100022', '13800138001', 1, NOW(), NOW(), 0),
(2, '李四', 2, '上海市', '上海市', '浦东新区', '陆家嘴环路1000号恒生银行大厦', '310115', '200120', '13800138002', 1, NOW(), NOW(), 0),
(3, '王芳', 3, '广东省', '深圳市', '南山区', '科技园南区高新南一道008号', '440305', '518057', '13800138003', 1, NOW(), NOW(), 0),
(4, '赵六', 4, '浙江省', '杭州市', '西湖区', '文三路398号东信大厦', '330106', '310013', '13800138004', 1, NOW(), NOW(), 0),
(5, '孙丽', 5, '江苏省', '南京市', '鼓楼区', '中山北路88号', '320106', '210008', '13800138005', 1, NOW(), NOW(), 0),
(6, '周杰', 6, '四川省', '成都市', '武侯区', '天府大道中段500号', '510107', '610041', '13800138006', 1, NOW(), NOW(), 0),
(7, '吴敏', 7, '湖北省', '武汉市', '洪山区', '光谷大道77号', '420111', '430074', '13800138007', 1, NOW(), NOW(), 0),
(8, '郑伟', 8, '山东省', '青岛市', '市南区', '香港中路100号', '370202', '266071', '13800138008', 1, NOW(), NOW(), 0),
(9, '陈静', 9, '福建省', '厦门市', '思明区', '软件园二期望海路10号', '350203', '361008', '13800138009', 1, NOW(), NOW(), 0),
(10, '刘洋', 10, '陕西省', '西安市', '雁塔区', '高新路52号', '610113', '710075', '13800138010', 1, NOW(), NOW(), 0);
...
INSERT INTO litemall_order (id, user_id, order_sn, order_status, aftersale_status, consignee, mobile, address, message, goods_price, freight_price, delivery_type, pickup_store_id, guide_id, coupon_price, integral_price, order_price, actual_price, pay_id, pay_time, ship_sn, ship_channel, ship_time, refund_amount, refund_type, refund_content, refund_time, confirm_time, comments, end_time, add_time, update_time, deleted) VALUES
-- 已完成订单
(1, 1, '202602270001', 401, 0, '张三', '13800138001', '北京市朝阳区建国路88号SOHO现代城A座1001', '尽快发货', 298.00, 0.00, 'express', NULL, 1, 0.00, 0.00, 298.00, 298.00, 'PAY202602270001', DATE_SUB(NOW(), INTERVAL 10 DAY), 'SF1234567890', '顺丰速运', DATE_SUB(NOW(), INTERVAL 9 DAY), NULL, NULL, NULL, NULL, DATE_SUB(NOW(), INTERVAL 7 DAY), 0, DATE_SUB(NOW(), INTERVAL 7 DAY), DATE_SUB(NOW(), INTERVAL 7 DAY), 0),
(2, 2, '202602270002', 401, 0, '李四', '13800138002', '上海市浦东新区陆家嘴环路1000号', '', 199.00, 0.00, 'express', NULL, 1, 0.00, 0.00, 199.00, 199.00, 'PAY202602270002', DATE_SUB(NOW(), INTERVAL 8 DAY), 'SF1234567891', '顺丰速运', DATE_SUB(NOW(), INTERVAL 7 DAY), NULL, NULL, NULL, NULL, DATE_SUB(NOW(), INTERVAL 5 DAY), 0, DATE_SUB(NOW(), INTERVAL 5 DAY), 0),
(3, 3, '202602270003', 401, 0, '王芳', '13800138003', '广东省深圳市南山区科技园南区高新南一道008号', '周末配送', 498.00, 0.00, 'express', NULL, 2, 10.00, 0.00, 498.00, 488.00, 'PAY202602270003', DATE_SUB(NOW(), INTERVAL 6 DAY), 'YT9876543210', '圆通快递', DATE_SUB(NOW(), INTERVAL 5 DAY), NULL, NULL, NULL, NULL, DATE_SUB(NOW(), INTERVAL 3 DAY), 0, DATE_SUB(NOW(), INTERVAL 3 DAY), 0),
-- 已发货订单
(4, 4, '202602270004', 301, 0, '赵六', '13800138004', '浙江省杭州市西湖区文三路398号东信大厦', '', 159.00, 0.00, 'express', NULL, NULL, 0.00, 0.00, 159.00, 159.00, 'PAY202602270004', DATE_SUB(NOW(), INTERVAL 3 DAY), 'ZTO1122334455', '中通快递', DATE_SUB(NOW(), INTERVAL 2 DAY), NULL, NULL, NULL, NULL, NULL, 0, NULL, 0),
(5, 5, '202602270005', 301, 0, '孙丽', '13800138005', '江苏省南京市鼓楼区中山北路88号', '易碎物品轻拿轻放', 399.00, 10.00, 'express', NULL, 1, 20.00, 0.00, 409.00, 389.00, 'PAY202602270005', DATE_SUB(NOW(), INTERVAL 2 DAY), 'JD5566778899', '京东快递', DATE_SUB(NOW(), INTERVAL 1 DAY), NULL, NULL, NULL, NULL, NULL, 0, NULL, 0),
-- 已付款待发货
(6, 6, '202602270006', 201, 0, '周杰', '13800138006', '四川省成都市武侯区天府大道中段500号', '', 658.00, 0.00, 'express', NULL, 2, 0.00, 50.00, 658.00, 608.00, 'PAY202602270006', DATE_SUB(NOW(), INTERVAL 1 DAY), NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0),
(7, 7, '202602270007', 201, 0, '吴敏', '13800138007', '湖北省武汉市洪山区光谷大道77号', '', 99.00, 10.00, 'express', NULL, NULL, 0.00, 0.00, 109.00, 109.00, 'PAY202602270007', NOW(), NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0),
-- 待付款
(8, 8, '202602270008', 101, 0, '郑伟', '13800138008', '山东省青岛市市南区香港中路100号', '', 558.00, 0.00, 'express', NULL, 1, 0.00, 0.00, 558.00, 558.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0),
(9, 9, '202602270009', 101, 0, '陈静', '13800138009', '福建省厦门市思明区软件园二期望海路10号', '送人用，包装精美点', 199.00, 0.00, 'express', NULL, 2, 0.00, 0.00, 199.00, 199.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0),
-- 用户取消
(10, 10, '202602270010', 102, 0, '刘洋', '13800138010', '陕西省西安市雁塔区高新路52号', '', 499.00, 0.00, 'express', NULL, 1, 0.00, 0.00, 499.00, 499.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0),
-- 自提订单
(11, 1, '202602270011', 401, 0, '张三', '13800138001', '北京市朝阳区建国路88号', '', 99.00, 0.00, 'pickup', 3, 1, 0.00, 0.00, 99.00, 99.00, 'PAY202602270011', DATE_SUB(NOW(), INTERVAL 5 DAY), NULL, NULL, NULL, NULL, NULL, NULL, NULL, DATE_SUB(NOW(), INTERVAL 4 DAY), 0, DATE_SUB(NOW(), INTERVAL 4 DAY), 0),
(12, 3, '202602270012', 301, 0, '王芳', '13800138003', '广东省深圳市南山区', '', 199.00, 0.00, 'pickup', 3, 2, 0.00, 0.00, 199.00, 199.00, 'PAY202602270012', DATE_SUB(NOW(), INTERVAL 1 DAY), NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0),
-- 更多已完成订单
(13, 5, '202602270013', 401, 0, '孙丽', '13800138005', '江苏省南京市鼓楼区中山北路88号', '', 258.00, 0.00, 'express', NULL, 1, 0.00, 0.00, 258.00, 258.00, 'PAY202602270013', DATE_SUB(NOW(), INTERVAL 15 DAY), 'SF9988776655', '顺丰速运', DATE_SUB(NOW(), INTERVAL 14 DAY), NULL, NULL, NULL, NULL, DATE_SUB(NOW(), INTERVAL 12 DAY), 0, DATE_SUB(NOW(), INTERVAL 12 DAY), 0),
(14, 6, '202602270014', 401, 0, '周杰', '13800138006', '四川省成都市武侯区天府大道中段500号', '', 499.00, 0.00, 'express', NULL, 2, 0.00, 0.00, 499.00, 499.00, 'PAY202602270014', DATE_SUB(NOW(), INTERVAL 20 DAY), 'EMS112233445', 'EMS', DATE_SUB(NOW(), INTERVAL 18 DAY), NULL, NULL, NULL, NULL, DATE_SUB(NOW(), INTERVAL 15 DAY), 0, DATE_SUB(NOW(), INTERVAL 15 DAY), 0),
(15, 8, '202602270015', 401, 0, '郑伟', '13800138008', '山东省青岛市市南区香港中路100号', '', 399.00, 0.00, 'express', NULL, 1, 0.00, 0.00, 399.00, 399.00, 'PAY202602270015', DATE_SUB(NOW(), INTERVAL 12 DAY), 'YD5544332211', '韵达快递', DATE_SUB(NOW(), INTERVAL 11 DAY), NULL, NULL, NULL, NULL, DATE_SUB(NOW(), INTERVAL 8 DAY), 0, DATE_SUB(NOW(), INTERVAL 8 DAY), 0);
...
-- 7. 广告
INSERT INTO litemall_ad (name, link, url, position, content, start_time, end_time, enabled, add_time, update_time, deleted) VALUES
('春季新品上市', '/goods/list', 'https://img.alicdn.com/imgextra/i4/2215304656488/O1CN01DP1xMN1h6CmBp0Umb_!!2215304656488.jpg', 1, '春季新品全场8折起', DATE_SUB(NOW(), INTERVAL 30 DAY), DATE_ADD(NOW(), INTERVAL 30 DAY), 1, NOW(), NOW(), 0),
('会员专享福利', '/user/index', 'https://img.alicdn.com/imgextra/i3/2215304656488/O1CN01vZQWZQ1h6CmE3qY6n_!!2215304656488.jpg', 1, '会员专享9折优惠', DATE_SUB(NOW(), INTERVAL 30 DAY), DATE_ADD(NOW(), INTERVAL 30 DAY), 1, NOW(), NOW(), 0),
('羽绒服特惠', '/goods/detail?id=1181006', 'https://img.alicdn.com/imgextra/i1/2215304656488/O1CN01ABC1231h6CmF4gH5i_!!2215304656488.jpg', 1, '轻薄羽绒服限时特惠', DATE_SUB(NOW(), INTERVAL 7 DAY), DATE_ADD(NOW(), INTERVAL 7 DAY), 1, NOW(), NOW(), 0);
